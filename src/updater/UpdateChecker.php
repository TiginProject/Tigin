...
class UpdateChecker{
	...
	protected function showChannelSuggestionStable() : void{
		$this->printConsoleMessage([
			...
			"To get notified about new Stable builds only, change 'preferred-channel' in your tigin.yml to 'stable'."
		]);
	}
	...
	protected function showChannelSuggestionBeta() : void{
		$this->printConsoleMessage([
			...
			"To get notified about new Beta or Development builds, change 'preferred-channel' in your tigin.yml to 'beta' or 'development'."
		]);
	}
