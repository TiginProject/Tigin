...
$defaultConfig = yaml_parse(Filesystem::fileGetContents(dirname(__DIR__) . '/resources/tigin.yml'));

if(!is_array($defaultConfig)){
	fwrite(STDERR, "Invalid default tigin.yml\n");
	exit(1);
}
...
/**
 * @internal
 * Constants for all properties available in tigin.yml.
